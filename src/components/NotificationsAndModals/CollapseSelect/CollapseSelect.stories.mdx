...
import PbCollapseSelect from './CollapseSelect.vue';
import { colors } from '@pb/utils/constants.js';

<Meta
  title="Components/Notifications and Modals/PbCollapseSelect"
  component={ PbCollapseSelect }
  argTypes={{
    label: {
      type: 'string',
...
# **PbCollapseSelect component**
### The `PbCollapseSelect` is a list of options that can be selected

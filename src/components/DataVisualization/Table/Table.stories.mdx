...
<Meta
  ...
  argTypes = {{
    ...
    rows: {
      ...
      defaultValue: [
        [
          ...
          { badges: [{ value: 'Finalizado', badgeColor: 'success-light', badgeFontColor: 'success', badgeSize: 'pb-md' }] },
        ],
        [
    ...
    badgeColor: { type: 'string', defaultValue: 'primary'},
    badgeFontColor: { type: 'string', defaultValue: 'white' },
    badgeSize: { type: 'string', defaultValue: 'pb-sm' },
...
| badgeColor                  | String                 |'primary'| Sets the background-color of the badge.                                                       |
| badgeFontColor              | String                 | 'white' | Sets the font-color of the badge.                                                             |
| badgeSize                   | String                 | 'pb-sm' | Sets the size of the badge. ('pb-sm', 'pb-md', 'pb-lg').
| type                        | String, Number         |         | A status badge. (Optional)
### Properties

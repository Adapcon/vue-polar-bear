...
<Meta
  ...
  argTypes = {{
    ...
    useInternalFilter: { type: 'boolean', defaultValue: true },
  }}
/>
  ...
  template: `
    <div style="background-color: white;">
      <PbTable
        ...
        :current-page="page"
        :use-internal-filter="useInternalFilter"
...
| useInternalFilter           | Boolean     | true    | It sets if the Table component will do the intern filter or just emit the sort event.                    |                                                                  |
